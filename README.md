...
[Scraper APIs](https://developers.oxylabs.io/products/web-scraper-api).
...
dedicated parsers [here](https://developers.oxylabs.io/products/web-scraper-api/features/custom-parser/parser-presets). If you want to use a dedicated parser to get structured data,
...
at
https://developers.oxylabs.io/products/web-scraper-api/integration-methods.
