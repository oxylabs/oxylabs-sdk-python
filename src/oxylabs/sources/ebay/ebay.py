...
class Ebay:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Ebay class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes eBay search results for a given query.
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes an eBay product page for a given product ID.

        Args:
            product_id (str): eBay product ID.
            domain (Optional[str]): Domain localization. Accepted values:
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
            user_agent_type (Optional[str]): Device type and browser.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from an eBay URL.

        Args:
            url (str): Direct URL to any eBay page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class EbayAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the EbayAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes eBay search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes an eBay product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from an eBay URL.
