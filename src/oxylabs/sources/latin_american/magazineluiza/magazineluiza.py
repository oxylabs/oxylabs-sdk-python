...
class Magazineluiza:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Magazineluiza class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Magazine Luiza search results for a given query.

        Args:
            query (str): The keyword or phrase to search for.
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
        ...
        payload = {
            "source": source.MAGAZINELUIZA_SEARCH,
            "query": query,
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Magazine Luiza product page for a given product ID.

        Args:
            product_id (str): Magazine Luiza product ID.
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.MAGAZINELUIZA_PRODUCT,
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Magazine Luiza URL.

        Args:
            url (str): Direct URL to any Magazine Luiza page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.MAGAZINELUIZA_URL,
            "url": url,
            "user_agent_type": user_agent_type,
            "render": render,
            "callback_url": callback_url,
...
class MagazineluizaAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the MagazineluizaAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Magazine Luiza search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Magazine Luiza product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Magazine Luiza URL.
