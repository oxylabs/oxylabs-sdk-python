...
class Mercadolivre:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Mercadolivre class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Mercado Livre search results for a given query.
        ...
        payload = {
            "source": source.MERCADOLIVRE_SEARCH,
            "query": query,
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Mercado Livre product page for a given product ID.

        Args:
            product_id (str): Mercado Livre product ID.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.MERCADOLIVRE_PRODUCT,
...
class MercadolivreAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the MercadolivreAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Mercado Livre search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Mercado Livre product page for a given product ID.
