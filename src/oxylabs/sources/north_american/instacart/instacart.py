...
class Instacart:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Instacart class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Instacart search results for a given query.
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes an Instacart product page for a given product ID.

        Args:
            product_id (str): Instacart product ID.
            domain (Optional[str]): Domain localization. Accepted values:
                            "com", "ca".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.INSTACART_PRODUCT,
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from an Instacart URL.

        Args:
            url (str): Direct URL to any Instacart page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class InstacartAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the InstacartAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Instacart search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes an Instacart product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from an Instacart URL.
