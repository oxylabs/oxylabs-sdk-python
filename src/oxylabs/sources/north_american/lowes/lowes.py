...
class Lowes:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Lowes class.
    ...
    def scrape_search(
        ...
        pickup_today: Optional[bool] = None,
        delivery_today_tomorrow: Optional[bool] = None,
        ...
        **kwargs
        ...
        """
        Scrapes Lowe's search results for a given query.

        Args:
            query (str): The keyword or phrase to search for.
            store_id (Optional[int]): Specify a store.
            delivery_zip (Optional[str]): Delivery location ZIP code.
            free_delivery (Optional[bool]): Filter for free delivery products.
            pickup_today (Optional[bool]): Filter for same day pickup availability.
            delivery_today_tomorrow (Optional[bool]): Filter for same/next day delivery.
        ...
        payload = {
            "source": source.LOWES_SEARCH,
            "query": query,
            "store_id": store_id,
            "delivery_zip": delivery_zip,
            "free_delivery": free_delivery,
            "pickup_today": pickup_today,
            "delivery_today_tomorrow": delivery_today_tomorrow,
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Lowe's product page for a given product ID.

        Args:
            product_id (str): Lowe's product ID.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Lowe's URL.

        Args:
            url (str): Direct URL to any Lowe's page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class LowesAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the LowesAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Lowe's search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Lowe's product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Lowe's URL.
