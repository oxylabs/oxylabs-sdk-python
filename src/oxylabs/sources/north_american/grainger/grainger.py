...
class Grainger:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Grainger class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Grainger search results for a given query.

        Args:
            query (str): The keyword or phrase to search for.
            domain (str): Domain localization. Accepted values:
                            "com", "com.mx", "ca".
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Grainger product page for a given product ID.

        Args:
            product_id (str): Grainger product ID.
            domain (str): Domain localization. Accepted values:
                            "com", "com.mx", "ca".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.GRAINGER_PRODUCT,
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Grainger URL.

        Args:
            url (str): Direct URL to any Grainger page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class GraingerAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the GraingerAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Grainger search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Grainger product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Grainger URL.
