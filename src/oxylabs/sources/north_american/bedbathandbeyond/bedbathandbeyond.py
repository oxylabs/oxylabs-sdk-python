...
class Bedbathandbeyond:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Bedbathandbeyond class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Bed Bath & Beyond search results for a given query.
        ...
        payload = {
            "source": source.BEDBATHANDBEYOND_SEARCH,
            "query": query,
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Bed Bath & Beyond product page for a given product ID.

        Args:
            product_id (str): 8-digit Bed Bath & Beyond product ID.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Bed Bath & Beyond URL.

        Args:
            url (str): Direct URL to any Bed Bath & Beyond page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.BEDBATHANDBEYOND_URL,
            "url": url,
            "user_agent_type": user_agent_type,
            "render": render,
            "callback_url": callback_url,
...
class BedbathandbeyondAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the BedbathandbeyondAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Bed Bath & Beyond search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Bed Bath & Beyond product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Bed Bath & Beyond URL.
