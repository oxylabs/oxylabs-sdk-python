...
class Bodegaaurrera:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Bodegaaurrera class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Bodega Aurrera search results for a given query.
        ...
        payload = {
            "source": source.BODEGAAURRERA_SEARCH,
            "query": query,
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Bodega Aurrera product page for a given product ID.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Bodega Aurrera URL.
...
class BodegaaurreraAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the BodegaaurreraAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Bodega Aurrera search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Bodega Aurrera product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Bodega Aurrera URL.
