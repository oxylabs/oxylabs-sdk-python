...
class Publix:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Publix class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Publix search results for a given query.
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Publix product page for a given product ID.

        Args:
            product_id (str): Publix product ID.
            store_id (Optional[int]): Specify a store.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Publix URL.

        Args:
            url (str): Direct URL to any Publix page.
            store_id (Optional[int]): Specify a store.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
...
class PublixAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the PublixAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Publix search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Publix product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Publix URL.
