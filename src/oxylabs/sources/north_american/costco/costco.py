...
class Costco:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Costco class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Costco search results for a given query.

        Args:
            query (str): The keyword or phrase to search for.
            domain (Optional[str]): Domain localization. Accepted values:
                            "com", "ca", "co.uk", "com.au", "com.mx", "fr",
                            "co.jp", "is", "co.nz", "co.kr", "es", "com.tw".
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Costco product page for a given product ID.

        Args:
            product_id (str): Costco product ID.
            domain (Optional[str]): Domain localization. Accepted values:
                            "com", "ca", "co.uk", "com.au", "com.mx", "fr",
                            "co.jp", "is", "co.nz", "co.kr", "es", "com.tw".
            user_agent_type (Optional[str]): Device type and browser.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Costco URL.

        Args:
            url (str): Direct URL to any Costco page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class CostcoAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the CostcoAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Costco search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Costco product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Costco URL.
