...
class Staples:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Staples class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Staples search results for a given query.
...
class StaplesAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the StaplesAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Staples search results for a given query.
