...
class Airbnb:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Airbnb class.
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes an Airbnb property page for a given room ID.

        Args:
            product_id (str): The unique numerical ID for an Airbnb property listing.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from an Airbnb URL.

        Args:
            url (str): Direct URL to any Airbnb page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class AirbnbAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the AirbnbAsync class.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes an Airbnb property page for a given room ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from an Airbnb URL.
