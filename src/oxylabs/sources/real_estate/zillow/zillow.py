...
class Zillow:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Zillow class.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Zillow URL.

        Args:
            url (str): Direct URL to any Zillow page.
...
class ZillowAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the ZillowAsync class.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Zillow URL.
