...
class Aliexpress:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Aliexpress class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes AliExpress search results for a given query.
        ...
        payload = {
            "source": source.ALIEXPRESS_SEARCH,
            "query": query,
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes an AliExpress product page for a given product ID.

        Args:
            product_id (str): AliExpress product ID.
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from an AliExpress URL.

        Args:
            url (str): Direct URL to any AliExpress page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class AliexpressAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the AliexpressAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes AliExpress search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes an AliExpress product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from an AliExpress URL.
