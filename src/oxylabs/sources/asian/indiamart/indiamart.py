...
class Indiamart:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Indiamart class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes IndiaMART search results for a given query.
        ...
        payload = {
            "source": source.INDIAMART_SEARCH,
            "query": query,
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes an IndiaMART product page for a given product ID.

        Args:
            product_id (str): IndiaMART product ID.
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.INDIAMART_PRODUCT,
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from an IndiaMART URL.

        Args:
            url (str): Direct URL to any IndiaMART page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class IndiamartAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the IndiamartAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes IndiaMART search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes an IndiaMART product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from an IndiaMART URL.
