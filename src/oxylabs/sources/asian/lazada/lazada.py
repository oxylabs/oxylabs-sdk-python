...
class Lazada:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Lazada class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Lazada search results for a given query.
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Lazada product page for a given product ID.

        Args:
            product_id (str): Lazada product ID.
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Lazada URL.

        Args:
            url (str): Direct URL to any Lazada page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class LazadaAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the LazadaAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Lazada search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Lazada product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Lazada URL.
