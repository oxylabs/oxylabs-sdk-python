...
class Avnet:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Avnet class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Avnet search results for a given query.
...
class AvnetAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the AvnetAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Avnet search results for a given query.
