...
class Tokopedia:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Tokopedia class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        payload = {
            "source": source.TOKOPEDIA_SEARCH,
            "query": query,
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Tokopedia URL.

        Args:
            url (str): Direct URL to any Tokopedia page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class TokopediaAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the TokopediaAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Tokopedia search results for a given query.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Tokopedia URL.
