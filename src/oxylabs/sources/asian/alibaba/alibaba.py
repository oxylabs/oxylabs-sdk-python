...
class Alibaba:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Alibaba class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Alibaba search results for a given query.
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes an Alibaba product page for a given product ID.

        Args:
            product_id (str): 13-digit Alibaba product ID.
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from an Alibaba URL.

        Args:
            url (str): Direct URL to any Alibaba page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class AlibabaAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the AlibabaAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Alibaba search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes an Alibaba product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from an Alibaba URL.
