...
class Flipkart:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Flipkart class.
    ...
    def scrape_product(
        ...
        **kwargs
        ...
        """
        Scrapes a Flipkart product page for a given product ID.

        Args:
            product_id (str): Flipkart product ID.
                            "com", "co.uk", "de", "ca", "com.au", "it",
                            "pl", "ph", "com.hk", "com.sg".
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
        ...
        config = prepare_config(request_timeout=request_timeout)
        payload = {
            "source": source.FLIPKART_PRODUCT,
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Flipkart URL.

        Args:
            url (str): Direct URL to any Flipkart page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class FlipkartAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the FlipkartAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Flipkart search results for a given query.
    ...
    async def scrape_product(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes a Flipkart product page for a given product ID.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Flipkart URL.
