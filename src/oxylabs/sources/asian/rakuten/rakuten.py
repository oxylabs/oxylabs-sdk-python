...
class Rakuten:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Rakuten class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Rakuten search results for a given query.
    ...
    def scrape_url(
        ...
        **kwargs
        ...
        """
        Scrapes content from a Rakuten URL.

        Args:
            url (str): Direct URL to any Rakuten page.
            user_agent_type (Optional[str]): Device type and browser.
            render (Optional[str]): Enables JavaScript rendering.
            callback_url (Optional[str]): URL to your callback endpoint.
            request_timeout (int | 165, optional): The interval in seconds for
...
class RakutenAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the RakutenAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Rakuten search results for a given query.
    ...
    async def scrape_url(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes content from a Rakuten URL.
