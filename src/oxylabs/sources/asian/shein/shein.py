...
class Shein:
    def __init__(self, api_instance: RealtimeAPI) -> None:
        """
        Initializes an instance of the Shein class.
    ...
    def scrape_search(
        ...
        **kwargs
        ...
        """
        Scrapes Shein search results for a given query.
...
class SheinAsync:
    def __init__(self, api_instance: AsyncAPI) -> None:
        """
        Initializes an instance of the SheinAsync class.
    ...
    async def scrape_search(
        ...
        **kwargs
        ...
        """
        Asynchronously scrapes Shein search results for a given query.
